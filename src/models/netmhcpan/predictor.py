        ...
        for mhc_name, group in df:
            ...
            with open('peptides2.txt', 'w') as file:
                for peptide in peptides2:
                    file.write(peptide + '\n')
            process1 = subprocess.Popen([cls._executable, '-p', 'peptides1.txt', '-a', mhc_name, '-l', '8,9,10,11,12,13,14', '-BA', '-xls', '-xlsfile', 'out.tsv'], stdout=subprocess.DEVNULL)
            process2 = subprocess.Popen([cls._executable, '-p', 'peptides2.txt', '-a', mhc_name, '-l', '8,9,10,11,12,13,14', '-BA', '-xls', '-xlsfile', 'out.tsv'], stdout=subprocess.DEVNULL)
            process1.wait()
            process2.wait()
